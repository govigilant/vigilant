...
<main class="grid min-h-full place-items-center bg-black px-6 py-24 sm:py-32 lg:px-8 bg-black">
    <div class="text-center">
        ...
        <div class="mt-10 flex items-center justify-center gap-x-6">
            <a href="/"
               class="rounded-md bg-red px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-red-light focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">@lang('Go back')</a>
        </div>
    </div>
</main>
</body>

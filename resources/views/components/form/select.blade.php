...
@endif
            <select id="{{ $field }}"
                    ...
                    {{ $attributes }}
                    class="mt-2 block w-full rounded-md border-0 py-1.5 pl-3 pr-10 text-white bg-white/5 ring-1 ring-inset ring-white/10 focus-within:ring-2 focus-within:ring-inset focus-within:ring-red disabled:bg-base-950">
                {{ $slot }}
            </select>

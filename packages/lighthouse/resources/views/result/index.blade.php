<x-app-layout>
    <x-slot name="header">
        <x-page-header :back="route('lighthouse.index', ['lighthouseSite' => $result->lighthouse_monitor_id])" title="Lighthouse Result - {{ $result->created_at->toDateTimeString('minute') }}">

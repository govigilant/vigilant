                    ...
                    <div class="space-y-4">
                        <div>
                            ...
                            <div class="flex items-center gap-2">
                                <input type="text" readonly value="{{ $healthcheck->token }}"
                        ...
                        @if ($healthcheck->type->value === 'endpoint')
                            <div class="bg-gray-50 dark:bg-gray-800 rounded-lg p-4">
                                <h5 class="font-semibold text-gray-900 dark:text-gray-100 mb-2">
                                    {{ __('Endpoint Details') }}</h5>
                                <div class="space-y-2 text-sm">
                                    <div>
                                        <span
                                            class="font-medium text-gray-700 dark:text-gray-300">{{ __('Domain:') }}</span>
                                        <span
                                            class="text-gray-600 dark:text-gray-400">{{ $healthcheck->domain }}</span>
                                    </div>
                                    <div>
                                        <span
                                            class="font-medium text-gray-700 dark:text-gray-300">{{ __('Endpoint:') }}</span>
                                        <span
                                            class="text-gray-600 dark:text-gray-400">{{ $healthcheck->endpoint }}</span>
                                    </div>
                                    <div>
                                        <span
                                            class="font-medium text-gray-700 dark:text-gray-300">{{ __('Check Interval:') }}</span>
                                        <span
                                            class="text-gray-600 dark:text-gray-400">{{ __('Every :interval minutes', ['interval' => $healthcheck->interval]) }}</span>
                                    </div>
                                </div>
                            </div>
                        @endif
